...
Sub-languages of interest are for example CNF or First-order Form (FOF) and are extracted based on the users selection which part of the language to maintain.
