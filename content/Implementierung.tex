	...
	\If {expression is COMMENT\textunderscore BLOCK}
		...
		\If{length(comment\textunderscore block\textunderscore list) == 1}
			\If{index < length(rules\textunderscore list.list) - 1}
				\State {next\textunderscore expression = rules\textunderscore list.list[index + 1]}
				\State rule\textunderscore type = this.find\textunderscore rule\textunderscore type\textunderscore for\textunderscore expression(next\textunderscore expression)
				\State {node\textunderscore key = Node\textunderscore Key(next\textunderscore expression.name, rule\textunderscore type)}
				...
				\Else
					\State previous\textunderscore expression = rules\textunderscore list.list[index - 1]
					\State rule\textunderscore type = this.find\textunderscore rule\textunderscore type\textunderscore for\textunderscore expression(previous\textunderscore expression)
					\State node\textunderscore key = Node\textunderscore Key(previous\textunderscore expression.name, rule\textunderscore type)
				\State this.nodes\textunderscore dictionary[node\textunderscore key].extend\textunderscore comment\textunderscore block( comment\textunderscore block\textunderscore list[0])
			\EndIf
