...
The docstrings of the Python functions contain a specification of the grammar's rules.
...
%Analogue to the T\textunderscore symbol data type, the NT\textunderscore SYMBOL also has the value of the nonterminal symbol token as an attribute. 
%
...
Algorithm \ref{alg:BuildGraphRek} calls the function \ref{alg:SearchProductionsListForNT} that appends children of a node to the nodes list of children.
