...
For example the regular expression \textbf{10*} denotes the language consisting of a single 1 followed by an arbitrary numver of 0's.\\
...
The aim of parsing is to establish a relationship among tokens generated by a lexer \cite{LexYacc.1992}.
