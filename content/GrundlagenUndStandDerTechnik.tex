...
A small tool chain based on Lex/Yacc for building a basic parser from the syntax is available \cite{VS06}. While the TPTP is a major success story, the resulting syntax is large and complex.
...
Figure \ref{fig:FiniteAutomaton} shows an automaton consisting of the three states $z\textsubscript{0}, z\textsubscript{1}$ and $z\textsubscript{2}$ and three transitions. The automaton accepts words consisting of a 1, an arbitrary amount of zeros and a 1. 
