...
-how is input of automaton processed?
-input alphabet
-error state omitted

A finite automaton can recognizes words of a language.
...
The start state is the state in which the automaton starts processing.
...
Non-deterministic can have multiple transitions for the same input.
...
Formal grammars describe how words of a language can be generated. and are thus able to describe ?more classes of? languages than regular expression can describe.
-In comparison to regular expressions, more classes of languages can be described. Regular expressions only describe regular languages.
