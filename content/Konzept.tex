...
\ac{PLY} offers a lexer generator for python (see section \ref{sec:BackgroundPythonPLY}).
...
First comment blocks, that are consecutive comment lines (see section \ref{sec:ConceptParserDataStructure}) are split into multiple separate comment blocks by using \textit{Top of Page} lines as separators
