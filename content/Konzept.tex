...
The tool should also provide a console interface. This interface should accept a \ac{TPTP} syntax file and a control file and output the sub-syntax described in the control file. It should be possible to specify the output file path and name.
...
todo architecture diagram and diagram description
...
Listing \ref{lst:ConceptComment_tptp} features an example of a comment in a \ac{TPTP} syntax file.
