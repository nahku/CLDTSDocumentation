...
\ac{Synplifier} MUST be able to display \ac{TPTP} syntax file.
\subsubsection{[R3]}\label{R3}
\subsubsection{[R4]}\label{R4}
\subsubsection{[R5]}\label{R5}
\ac{Synplifier} has a GUI that is the interface between \ac{Synplifier} and a user. Hence, the user communicates with \ac{Synplifier} via the GUI. The user is able to import a syntax file. After the syntax file is imported, it should is displayed. 
