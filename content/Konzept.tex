...
-delete the productions that are specified in control file
\subsection{Determination of the remaining reachable symbols}
-determine which nonterminal symbols are still reachable, without productions specified in control file
-starting with start symbol traverse grammar graph
-
dynamic programming
